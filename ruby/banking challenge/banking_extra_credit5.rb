...
class Bank
	...
	def total_cash_in_bank
		@total = 0
		@accounts.each {|name, balance| @total += balance}
...
#credit card system
	...
	def create_credit_account(person)
		@credit_accounts[person.name] = 0
		puts "#{person.name} has a credit account."
	end
...
chase.create_credit_account(me)
